					...
					<div class="row mb-2">
						...
						<div class="col-md-4">
							<label>Confirme a nova senha:</label> <input type="password"
								name="novaSenhaConfirmacao" id="novaSenhaConfirmacao"
								class="form-control" />
						</div>
...
@5.2.2/dist/js/bootstrap.bundle.min.js"></script>
	...
	<script
		src="https://cdn.jsdelivr.net/npm/jquery-validation
@1.19.5/dist/jquery.validate.min.js"></script>

	<script
		src="https://cdn.jsdelivr.net/npm/jquery-validation
@1.19.5/dist/additional-methods.min.js"></script>
