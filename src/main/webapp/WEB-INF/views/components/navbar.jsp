		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/projetoweb01/admin/dashboard">Dashboard</a>
				</li>
				<li class="nav-item"><a class="nav-link"
					href="/projetoweb01/admin/minhaconta">Minha conta</a></li>
				<li class="nav-item dropdown"><a
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item"
							href="/projetoweb01/admin/cadastrarcontatos">Cadastrar
								Contatos</a></li>
						<li><a class="dropdown-item"
							href="/projetoweb01/admin/consultarcontatos">Consultar
								Contatos</a></li>
					</ul></li>
			</ul>
